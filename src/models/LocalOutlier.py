...
class RetrainBestTrial:
    ...
    def plot_anomalies(self, X_val: np.ndarray, y_val: np.ndarray, y_pred_val: np.ndarray, column_index: int, data: str) -> None:
        """
...
class IF_testing:
    ...
    def retrainer(self, ablation_type, metric, n_decrement, n=None):
        """
