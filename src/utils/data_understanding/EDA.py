        ...
        if plot_type == 'matplotlib':
            ...
            for seq in unique_seqs:
                ...
                if 1 <= instance_to_plot <= total_windows:
                    ...
                    print(f'Invalid instance number for unique code {seq}. Please choose a number between 1 and {total_windows}.')
        ...
        if plot_type == 'matplotlib':
            ...
            for seq in unique_seqs:
                ...
                if 1 <= instance_to_plot <= total_windows:
                    ...
                    print(f'Invalid instance number for unqiue code {seq}. Please choose a number between 1 and {total_windows}.')
    ...
    def plot_scatter_matrix(self, instance_to_plot, cols):
        ...
        for unique_code in unique_codes:
            ...
            if 1 <= instance_to_plot <= total_windows:
                ...
                print(f'Invalid instance number for unique code {unique_code}. Please choose a number between 1 and {total_windows}.')
