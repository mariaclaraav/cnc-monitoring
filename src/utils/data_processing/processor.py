...
import logging
from src.utils.data_processing.setup import SetupData
...
class OperationProcessor:
    ...
    def process_operations(self) -> Tuple[List[pd.DataFrame], List[pd.DataFrame], List[pd.DataFrame]]:
        ...
        for operation in tqdm(self.operations, desc="Processing Operations"):
            ...
            X_train, y_train, X_val, y_val, X_test, y_test, unique_code_train, unique_code_test, unique_code_val, scaler = SetupData(
                data,
