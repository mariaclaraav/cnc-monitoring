...
class DataSaver:
    ...
    def save_dataframes(self):
        ...
        logger.info(f"Final train DataFrame saved to {os.path.join(self.__output_dir, f'final_val_{self.__group}.parquet')}")
        del final_train_df
        ...
        if self.__val_dfs:
            ...
            logger.info(f"Final validation DataFrame saved to {os.path.join(self.__output_dir, f'final_train_{self.__group}.parquet')}")
            del final_val_df
        ...
        if self.__test_dfs:
            ...
            logger.info(f"Final test DataFrame saved to {os.path.join(self.__output_dir, f'final_test_{self.__group}.parquet')}")
            del final_test_df
