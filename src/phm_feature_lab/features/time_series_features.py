...
class TimeSeriesFeatures:
    ...
    def process_time_series(
        ...
        'frequency': lambda data: FeatureCreationUtils.statistical_frequency_features(
            data=data, window_size=self.__window_size,
            step_size=self.__step_size, min_periods=self.__min_periods, fs=self.__sampling_rate),
